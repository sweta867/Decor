...
return array(
	...
	'trading-country' => array(
		...
		'type'				=> 'select',
		'options'			=> array(
									'auto' => __( 'Auto', 'woo_afterpay' ),
									'AU' => __( 'Australia', 'woo_afterpay' ),
									'CA' => __( 'Canada', 'woo_afterpay' ),
									'NZ' =>__( 'New Zealand', 'woo_afterpay' ),
									'US' => __( 'United States', 'woo_afterpay' )
								),
		'description'		=> __( 'Select the country in which your Afterpay merchant account is based.', 'woo_afterpay' ),
		'default'			=> 'auto'
	),
