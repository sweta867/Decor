                ...
                <?php } else { ?>
                    ...
                    <div class="connect-buttons">
                        <fieldset class="connect-button">
                            ...
                            <a id="wck_create_account" class="button create-account" href="https://www.klaviyo.com/signup/woocommerce?utm_medium=app-store&utm_source=platform-partner&utm_campaign=woocomm-launch" target="_blank">Create Account</a>
                        </fieldset>
                    </div>
                <?php } ?>
            </div>
